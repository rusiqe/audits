...
A time-boxed security review of the **protocol name** protocol was done by **Tau**, with a focus on the security aspects of the application's implementation.
...
Krum Tau, or **Tau**, is an independent smart contract security researcher. Having found numerous security vulnerabilities in various protocols, he does his best to contribute to the blockchain ecosystem and its protocols by putting time and effort into security research & reviews. Reach out on Twitter [@rusiqe](https://twitter.com/rusiqe)
